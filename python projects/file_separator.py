#this is a file separator project in which
#suppose you have a folder have different different extensions files
#like -> .mp4,.mp3,.jpg,.png,.doc,.pdf
#we have to separate this files extension in diferent-different folders
